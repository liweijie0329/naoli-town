...
- 自动记录总分、教育水平加分、每题得分、每题用时、总用时、连线序列、敲击反应、画图图片、语音答题音频、AI 评分结果。
- 听力测试会隐藏记录环境检测结果、声道检查、练习和正式测试每一次“听到了/没听到”反应；变量说明见 [docs/data-dictionary.md](./docs/data-dictionary.md)。
